    ...
    <div className="min-h-screen w-screen flex flex-col relative overflow-hidden">
      <div
        ...
        style={{
          ...
          backgroundImage:
            'radial-gradient(circle at 25% 25%, rgba(255,255,255,0.08) 0, transparent 45%), radial-gradient(circle at 75% 75%, rgba(255,255,255,0.06) 0, transparent 45%)',
        }}
      />

      <nav className="relative z-20 pointer-events-none font-heading">
      ...
      <main className="flex-1 flex items-center justify-center relative z-10 px-4 sm:px-6 lg:px-8 min-h-[80vh] pointer-events-none">
        <div className="max-w-5xl mx-auto text-center space-y-8 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 pointer-events-auto">
            ...
            <Link href="#how-it-works" className="text-sm font-light text-white/80 hover:text-white transition-colors">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <footer className="relative z-10 border-t border-white/10 py-8 px-4 sm:px-6 lg:px-8 pointer-events-none">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center select-none">
          ...
          <p className="text-xs font-light text-white/40 pointer-events-none">© 2024 grantly. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
