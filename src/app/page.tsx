    ...
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Our AI analyzes your profile and matches you with scholarships that fit your
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Get personalized email digests every week with new scholarship opportunities that
                match your profile.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Keep track of all your scholarship applications, deadlines, and status in one
                organized dashboard.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Find Your Perfect Scholarship?</h2>
          <p className="text-xl text-primary-100 mb-8">
            Join thousands of students who are finding scholarships that match their unique
            profiles.
          </p>
          <Link
            href="/api/auth/login"
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm">© 2024 ScholarshipFinder. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
